...
export const EMBEDDING_MODELS = [
  ...
  },
  {
    ...
    vendor: "Alibaba (open, Apache 2.0)",
    paramsMillion: 434,
    dims: 1024,
    maxTokens: 8192,
  ...
  },
  {
    id: "nv-embed-v2",
    name: "NV-Embed-v2",
    vendor: "NVIDIA (open weights, non-commercial, Mistral-7B based)",
    paramsMillion: 7850,
    dims: 4096,
    maxTokens: 32768,
    license: { name: 'CC-BY-NC 4.0', commercial: 'non-commercial', note: 'Non-commercial use only; commercial deployments need a different embedding model or a license from NVIDIA.' },
  ...
  },
  {
    ...
    maxTokens: 8192,
    license: { name: 'MIT', commercial: 'open' },
    notes: "Multilingual (100+ languages), 8k-token inputs, and dense + sparse retrieval from one model at BERT-large-class cost.",
  },
  {
    ...
    maxTokens: 32768,
    license: { name: 'Apache 2.0', commercial: 'open' },
    notes: "32k-token inputs at small-model cost; a commercially licensed option for long documents.",
  },
  {
    ...
    maxTokens: 32768,
    license: { name: 'Apache 2.0', commercial: 'open' },
    notes: "Top-tier multilingual retrieval quality with 32k-token inputs and a commercial-friendly license, at LLM-class compute cost.",
  },
];
